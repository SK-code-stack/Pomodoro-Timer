...
If you'd rather have a localhost URL:

```bash
python3 -m http.server 8080
# then go to http://localhost:8080/pomodoro-timer.html
```

Or `npx serve .` if you have Node handy.

No npm, no bundler, no environment setup. It's a single self-contained HTML file.
